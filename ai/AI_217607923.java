...
public class AI_217607923 extends com.leekwars.generator.fight.entity.EntityAI {
public AI_217607923() throws LeekRunException {
super(34, 2);
}
...
if (ops((ops((ops((ops(neq(u_tcell, null), 1) && ops(moreequals(u_gpl, u_i), 1)), 0) && ops(lessequals(u_gpl, u_MP), 1)), 0) && ops(!bool(load(sysexec(LeekFunctions.inArray, u_acc, new ArrayLeekValue(AI_217607923.this, new Object[] { u_gpl, u_tcell }, false)))), 1)), 0)) {
ops(put(u_acc, u_k, new ArrayLeekValue(AI_217607923.this, new Object[] { u_gpl, u_tcell }, false)), 1);
...
Object u_res = ops(new ArrayLeekValue(AI_217607923.this, new Object[] { false, 0 }, false), 1);
...
ops(1);Object u_res = ops(new ArrayLeekValue(AI_217607923.this, new Object[] { false, null, null }, false), 1);
...
ops(1);Object u_res = ops(new ArrayLeekValue(AI_217607923.this, new Object[] { false, load(sysexec(com.leekwars.generator.FightFunctions.getCell, new Object[] { null })) }, false), 1);
...
ops(u_res = new ArrayLeekValue(AI_217607923.this, new Object[] { true, get(u_accMe, u_i, null) }, false), 1);
ops(1);}
...
Object u_acc = ops(new ArrayLeekValue(AI_217607923.this, new Object[] { load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, sub(u_cx, 2), u_cy)), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, sub(u_cx, 1), sub(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, sub(u_cx, 1), u_cy)), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, sub(u_cx, 1), add(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, u_cx, sub(u_cy, 2))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, u_cx, sub(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, u_cx, u_cy)), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, u_cx, add(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, u_cx, add(u_cy, 2))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, add(u_cx, 1), sub(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, add(u_cx, 1), u_cy)), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, add(u_cx, 1), add(u_cy, 1))), load(sysexec(com.leekwars.generator.FightFunctions.getCellFromXY, add(u_cx, 2), u_cy)) }, false), 17);
...
if (!g_init_ADN) { g_ADN = "A083N161F049A031A000A204A204A038A188A201A193A201A200A200A200A200A200"; g_init_ADN = true; ops(1); }
...
protected String getAIString() { return "test/ai/gen_3.leek";}
protected String[] getErrorFiles() { return new String[] {"test/ai/gen_3.leek", };}
